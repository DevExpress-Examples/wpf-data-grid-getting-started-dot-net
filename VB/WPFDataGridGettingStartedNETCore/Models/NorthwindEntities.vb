...
Namespace WPFDataGridGettingStartedNETCore.Models
    ...
    Public Partial Class NorthwindEntities
        ...
        Public Shared Function GetFile(ByVal fileName As String, ByVal directoryName As String) As String
            Dim appDirectory As String = Path.GetDirectoryName(Assembly.GetEntryAssembly().Location)
        ...
        Protected Overrides Sub OnModelCreating(ByVal modelBuilder As ModelBuilder)
            ...
            modelBuilder.Entity(Of CustomerDemographic)(Sub(entity)
                ...
                RelationalPropertyBuilderExtensions.HasColumnName(entity.Property(Function(e) e.CustomerTypeId), "CustomerTypeID").HasMaxLength(10).IsFixedLength()
            ...
            modelBuilder.Entity(Of Customer)(Sub(entity)
                ...
                RelationalPropertyBuilderExtensions.HasColumnName(entity.Property(Function(e) e.CustomerId), "CustomerID").HasMaxLength(5).IsFixedLength()
            ...
            modelBuilder.Entity(Of Region)(Sub(entity)
                ...
                RelationalPropertyBuilderExtensions.HasColumnName(entity.Property(Function(e) e.RegionId), "RegionID").ValueGeneratedNever()
            ...
            modelBuilder.Entity(Of Territory)(Sub(entity)
                ...
                RelationalPropertyBuilderExtensions.HasColumnName(entity.Property(Function(e) e.TerritoryId), "TerritoryID").HasMaxLength(20)
